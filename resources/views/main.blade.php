...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#zonaintegritas" class="nav-link scrollto"><span>Zona Integritas</span> <i
                    ...
                    <li class="dropdown"><a class="nav-link scrollto" href="#contact"><span>Lainnya</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
    ...
    <main id="main">
        ...
        @include('section.tahapzi')
        @include('section.zonaintegritas')
